    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
            ...
            <a class="col-lg-offset-5 btn btn-primary" href="{{ route('video.create')}}">Add New course</a>
        ...
        <div class="box-body">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Videos that are already exist</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                   ...
                   @foreach ($videos as $vid)
                    <tr>
                      ...
                      <td>{{$vid->title}}</td>
                      <td>{{$vid->link}}</td>
                      <td><a href="{{ route('video.edit',$vid->id)}}"><i class="fa fa-fw fa-edit"></i></a></td>
                      <td>
                        <form id="cat-delete-form-{{$vid->id}}" action="{{ route('video.destroy',$vid->id)}}" method="post" style="display: none" >
