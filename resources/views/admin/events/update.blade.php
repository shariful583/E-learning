                  ...
                  <div class=" col-lg-offset-1 col-lg-6">
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <textarea class="form-control" name="des" id="des" cols="30" rows="10">@isset($event->description){{$event->description}}@endisset</textarea>
                       </div>
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="speaker1" name="speaker1" value="{{$event->speaker1}}">
                       </div>

                       <div class="form-group">
                        <label for="speaker2">Speaker Name</label>
                        <input type="text" class="form-control" id="speaker2" name="speaker2" value="@isset($event->speaker2){{$event->speaker2}}@endisset">
                       </div>
                       <div class="form-group">
                        <label for="speaker3">Speaker Name</label>
                        <input type="text" class="form-control" id="speaker3" name="speaker3" value="@isset($event->speaker2){{$event->speaker2}}@endisset">
                       </div>
                      ...
                      <div class="form-group">
                       <button type="submit" class="btn btn-primary" id="saveBtn">Update Event</button>
